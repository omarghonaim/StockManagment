...
function Index() {
  ...
  const updateItem = () => {
    ...
    axiosIstance
      .post("masterFile/update", updateItem)
      .then((res) => {
  ...
  const search_Item = () => {
    ...
    if (search_value && search_value.length > 0) {
      let search = MasterFile_Items.filter(
        (item) => item.item_code === search_value
      );
    ...
    <React.Fragment>
      <div className="col-sm-8 offset-sm-2 master_file_wrapper">
        ...
        <div className="row justify-content-center">
          <label for="exampleDataList" className="form-label labelsStyle">
            Search Items
          </label>
                    ...
                    <tr key={item.id}>
                      ...
                      <td>
                        <div>
                          ...
                          <Button
                            className="m-1"
                            onClick={() => handleShow_update(item)}
                          >
                            Edit
                          </Button>
                        </div>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  >
                    {Master_Item.is_active ? "Active" : "Disabled"}
                  </span>
                </td>
              </tr>
              <tr>
              ...
              <FormGroup row>
                ...
                <Col sm={9}>
                  <Input
                    type="text"
                    name="retail_price"
                    value={Master_Item.retail_price}
                    onInput={(e) => {
                      setMaster_Item({
                        ...Master_Item,
      ...
      <Modal show={show_New_Item} onHide={handleClose_New_Item}>
        ...
        <Form className="form">
          ...
          <Modal.Footer className="d-flex justify-content-center">
            <Button className="btn btn-success " onClick={() => Add_New_Item()}>
              ADD
            </Button>
          </Modal.Footer>
        </Form>
